...
class CLI:
    ...
    def _stats(self, articles):
        ...
        with open(os.path.join(OUTPUT_DIR, 'stats_daily.csv'), 'w') as f:
        ...
        with open(os.path.join(OUTPUT_DIR, 'stats_freq_tags.csv'), 'w') as f:
        ...
        with open(os.path.join(OUTPUT_DIR, 'stats_best_cps.csv'), 'w') as f:
            fields = [
        ...
        with open(os.path.join(OUTPUT_DIR, 'stats_worst_cps.csv'), 'w') as f:
            fields = [
                'cp_name', 'cp_name_masked', 'clean', 'bad', 'total', 'ratio'
            ]
            csvw = csv.DictWriter(f, fields)
    ...
    def _get_articles(self):
        """Yields all articles in INPUT_DIR"""
        filenames = (fn for fn in sorted(os.listdir(INPUT_DIR))
                     if fn.endswith('.csv'))
